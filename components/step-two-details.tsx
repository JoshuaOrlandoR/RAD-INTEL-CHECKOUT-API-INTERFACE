              ...
              <div className="step2-section__content px-6 pb-6">
                ...
                <div className="step2-contact-fields space-y-4 mb-6">
                  <div className="step2-contact-field flex justify-between items-center py-2 border-b border-[#f3f4f6]">
                    <span className="step2-contact-field__label text-gray-500">First Name</span>
                    <input
                      type="text"
                      value={firstName}
                  ...
                  <div className="step2-contact-field flex justify-between items-center py-2 border-b border-[#f3f4f6]">
                    <span className="step2-contact-field__label text-gray-500">Last Name</span>
                    <input
                      type="text"
                      value={lastName}
                  ...
                  <div className="step2-contact-field flex justify-between items-center py-2 border-b border-[#f3f4f6]">
                    <span className="step2-contact-field__label text-gray-500">Email</span>
                    <input
                      type="email"
                      value={email}
              ...
              <div className="step2-section__content px-6 pb-6">
                ...
                {submitSuccess ? (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-green-600 mt-1">Your investment of {formatCurrency(amount)} has been successfully recorded.</p>
                  </div>
                ) : (
                  <button
                    type="button"
